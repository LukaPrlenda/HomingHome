...
/*
    ...
    showDeleteAccountModal: function(){
        msg = `<p>WARNING!</p>
                        ...
                        <div>
                            <a id="modalYesToDeleteAccount" type="button" class="button-to-delete-account">Delete My account</a>
                            <a id="modalNoToDeleteAccount" type="button" class="button-to-delete-account">Do not delete account</a>
                        </div>  
                        `

                $("#notification_red").html(msg);

                ButtonEventListoner.addBtnModalDeleteMyAccount();
    ...
    hideModalWithoutDeleting: function() {
        document.getElementById("notification_red").style.display="none";
    },
    ...
    deleteMyAccount: function() {
        ...
        RestClient.delete(
            ...
            error => {
                msg = `<p>Error!</p>
                        <p>Error while deleting your account</p>`
