...
class UserDao extends BaseDao{
    ...
    public function get_basuc_data_by_id($id){
    ...
    public function get_by_username($username){
        return $this->query_unique('SELECT id, username, password FROM ' . $this->teble_name . ' WHERE username = :username', ['username' => $username]);
    }
}
?>